...
namespace TuniPharma\UserBundle\Controller;
...
use TuniPharma\MainBundle\Entity\Pharmacien;
    ...
    public function registerAction(Request $request) {
        ...
        if ('POST' === $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                $pharmacien->setPrénom($user->getPrenom());
                $pharmacien->setCin($user->getCin());
                $pharmacien->setEtat('active');
                $doctrineRegistry = $this->container->get('doctrine');
                $em = $doctrineRegistry->getManager();
                $em->persist($pharmacien);
                $em->flush();
                $user->setPharmacien($pharmacien->getRef());
