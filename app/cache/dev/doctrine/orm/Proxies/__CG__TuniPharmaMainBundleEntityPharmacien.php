...
namespace Proxies\__CG__\TuniPharma\MainBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Pharmacien extends \TuniPharma\MainBundle\Entity\Pharmacien implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'ref', 'nom', 'prenom', 'cin', 'etat', 'numtel', 'email');
        }
